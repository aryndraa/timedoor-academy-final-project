    ...
    <>
      <section>
        ...
        <div className="relative z-10 ">
          <div>
            <Link href={"/movies"} className="absolute transform -translate-y-14 text-3xl p-2 rounded-full bg-white/40 text-white ">
                <IoArrowBack/>
            </Link>
          </div>
          <div className="flex flex-col mt-2">
            ...
            <div className="grid grid-cols-3 border-y py-4 relative  border-border/20">
