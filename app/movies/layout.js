  ...
  return (
    <>
     <section className="min-h-[60vh] flex flex-col  py-8 lg:mx-16 pb-12 lg:pb-24">
       <div className=" mb-8 lg:mb-12 flex flex-col lg:flex-row-reverse lg:justify-between lg:items-center gap-10">
       <div className="rounded-full p-3 px-4 pl-6 bg-dark-200  w-full lg:max-w-[30%] flex justify-between items-center" >
