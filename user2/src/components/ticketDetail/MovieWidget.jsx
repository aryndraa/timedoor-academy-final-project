...
export const MovieWidget = () => {
  return (
    <div className="p-6 min-w-[300px] border border-border/20 ">
      <img
      ...
      />
      <div>
        <h1 className="text-xl font-medium pb-4 mb-4 border-b border-border/20">Ruroinin Kenshin : Origin</h1>
        <div className="text-text-400 flex flex-col gap-4">
