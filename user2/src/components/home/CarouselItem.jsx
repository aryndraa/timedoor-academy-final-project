    ...
    <div className="max-h-[70vh] flex ">
      <div className="flex-1 pl-20 max-w-lg bg-gradient-to-r from-dark-300 to-dark-300/0 flex-col flex justify-center ">
        <div className="mb-6">
          ...
          <p className="text-text-200">Setelah bertemu dengan Presiden AS yang baru terpilih, Thaddeus Ross (Harrison Ford), Sam Wilson (Anthony Mackie), Captain America yang....</p>
        </div>
