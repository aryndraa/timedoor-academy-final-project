...
export const GuestLink = () => {
  ...
  return authorize ? (
      ...
      <div className="flex items-center gap-2 lg:gap-4 ">
        <Link className="px-4 py-2 border border-primary text-primary rounded-lg text-sm font-bold" href={'/profile/login'}>Login</Link>
        <Link className="px-4 py-2 border border-primary text-dark-300 rounded-lg text-sm font-bold bg-primary" href={'/profile/register'}>Register</Link>
      </div>
    )
}